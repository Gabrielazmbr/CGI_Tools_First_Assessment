"""
With this test I was trying to link my bouncing ball
with a straight surface and see the implications and changes
I needed in my code to still achieve a proper bounce.
"""
...
class BouncingBall:
    ...
    def bounce(self):
        ...
        for i in range(0, vertex_count, 3):
            vertex_pos = cmds.pointPosition(f"{self.plane}.vtx[{i}]", world=True)
